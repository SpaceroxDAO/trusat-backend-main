...
class Database:
    ...
    def __init__(self, db_config_path):
        ...
        self._dbname = 'space'
        self._dbtype = 'sqlserver'
        self._dbhostname = 'localhost'
        self._dbusername = 'root'
        ...
        if (self._dbtype == "sqlserver"):
            self.charset_string = "CHARSET=utf8 ENGINE=InnoDB;"
        ...
        self.updateObserverNonceBytes_query = '''UPDATE Observer SET nonce=? WHERE eth_addr=?'''
        ...
        self.getObserverNonceBytes_query = '''SELECT nonce FROM Observer WHERE eth_addr=?'''
